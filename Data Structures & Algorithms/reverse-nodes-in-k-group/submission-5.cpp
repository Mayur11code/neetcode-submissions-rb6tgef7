...
public:
    ...
    ListNode* reverseKGroup(ListNode* head, int k) {
        ...
        // ==========================================
        // PHASE 1: Reverse the first group
        // ==========================================
        ...
        while (curr != nullptr) {
            ...
            ListNode* nxt = curr->next; // THE LIFEBOAT: Save the future path
            
            // THE SMUGGLE: Hide the old tail in the new tail's next pointer
            ...
            // THE MAGIC WIRE: Connect previous group's tail to this group's head
